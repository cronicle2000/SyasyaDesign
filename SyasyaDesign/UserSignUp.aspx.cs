	...
	public partial class UserSignUp1 : System.Web.UI.Page
	{
        ...
        void signUpNewMember()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO member_login(full_name,dob,contact_no,email,state,city,postcode,full_address,member_id,password,account_status) values(@full_name,@dob,@contact_no,@email,@state,@city,@pincode,@full_address,@member_id,@password,@account_status)", con);
